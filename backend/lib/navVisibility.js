...
const MODULES = [
  ...
  { key: 'clients', label: 'Manage clients', area: 'office' },
  ...
  { key: 'team-chat', label: 'Team chat (office + site groups)', area: 'office' },
...
function defaultRow(key) {
  ...
  const map = {
    ...
    drawings: adminOnly,
    'ai-bot': adminOnly,
    'team-chat': { admin: true, mis: true, employee: true, site: true, site_head: true },
